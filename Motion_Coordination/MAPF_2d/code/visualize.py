...
class Animation:
    def __init__(self, my_map, starts, goals, paths):
        # set animation contents in arguments, including starts, goals, paths
        ...
        # set animation basic elements, including figure, axes, patches(boundary plot, obstacles, agent), artists(agents' name)
        ...
        # draw the starts and related agents' name(artists) in circle(patches)
        ...
        # show animate_func: animate the position along the planned path of each agent at sample time t by get_state(t, path)
